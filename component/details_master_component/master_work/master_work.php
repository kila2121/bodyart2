<div class="master-section works-section">
    <div class="section-header-with-link">
        ...
        <a href="/page/gallery.php?master=<?= $master['id'] ?>" class="section-link">
            Все работы (<?= $worksCount ?>) <i class="fas fa-arrow-right"></i>
        </a>
    </div>
    <div class="works-grid">
        ...
        <div class="work-item" onclick="window.location.href='/page/gallery.php?id=<?= $work['id'] ?>'">
            <img src="<?= htmlspecialchars($work['url']) ?>" 
                    alt="<?= htmlspecialchars($work['title'] ?? 'Работа мастера') ?>"
                    loading="lazy">
